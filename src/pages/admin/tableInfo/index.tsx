...
import {deleteTableInfo, listTableInfoByPage, updateTableInfo} from "@/services/tableInfoService";
...
const AdminTableInfoPage: React.FC<unknown> = () => {
    ...
    const [updateData, setUpdateData] = useState<TableInfoType.TableInfo>({} as TableInfoType.TableInfo);
